...
def calculatecoeffients(sample_list,couplingstoscan):
    ...
    with open('vbfhhc2vline_cv.txt', 'w') as the_file:
...
sample_list = [
    sample(1,1,1,   val_xs = 0.001668),
    sample(1,2,1,   val_xs = 0.01374),
    sample(1,1,2,   val_xs = 0.001375),
    sample(1,1,0,   val_xs = 0.004454),
    sample(0.5,1,1, val_xs = 0.01046),
    sample(1.5,1,1, val_xs = 0.0638)
]  
#sample_list = [
#    sample(1,1,1,   val_xs = 0.001668),
#    sample(1,2,1,   val_xs = 0.01369),
#    sample(1,1,2,   val_xs = 0.001373),
#    sample(1,1,0,   val_xs = 0.004442),
#    sample(0.5,1,1, val_xs = 0.01041),
#    sample(1.5,1,1, val_xs = 0.06377)
#]  

#Create an array with couplings (cv,c2v,kl) to scan. In our case is c2v scan.
#couplingstoscan_list = [ [1,-5.0 + (x*0.1),1] for x in range(0,121)]  #c2v grid   
