...
allProcsNames = 'hh_SM,hh_SM_generated,vbfhh,ggh,qqh,tth,vh,bbhyb2,bbhybyt'.split(',')
allProcs = []
...
if options.do2D : 
   signalPdfName = 'MXMggpdfsm' #'hhbbggpdfsm'
