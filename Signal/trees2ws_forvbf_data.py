...
def get_options():
    ...
    parser.add_option("--inp-files",type='string',dest='inp_files',default='DoubleEG')  
    parser.add_option("--inp-dir",type='string',dest="inp_dir",default='/eos/user/m/mukherje/HH_bbgg/Ntuples_12_06_2020/Flattrees/')
    parser.add_option("--out-dir",type='string',dest="out_dir",default='/eos/user/m/mukherje/HH_bbgg/Ntuples_12_06_2020/WS_forplot/')
    ...
    #parser.add_option("--cats",type='string',dest="cats",default='DoubleHTag_0,DoubleHTag_1,DoubleHTag_2,DoubleHTag_3,DoubleHTag_4,DoubleHTag_5,DoubleHTag_6,DoubleHTag_7,DoubleHTag_8,DoubleHTag_9,VBFDoubleHTag_0,VBFDoubleHTag_1')
