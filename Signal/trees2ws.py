...
def get_options():
    ...
    parser.add_option("--out-dir",type='string',dest="out_dir",default='/work/nchernya/DiHiggs/inputs/06_05_2019/')
   ...
   for syst in systematics[0] : 
      for cat in cats : 
        ...
        # else : systematics_datasets += add_dataset_to_workspace( data, ws, name )
         if not opt.add_benchmarks : systematics_datasets += add_dataset_to_workspace( data, ws, newname)
