...
OUTDIR="output/out_20_02_2019_set"$YEAR2
...
INDIR="/mnt/t3nfs01/data01/shome/nchernya/DiHiggs/inputs/"
INTLUMI=77.4
CONFIGDAT="config_13_12_nodes"$YEAR".dat"
...
OUTDIR="output/out_21_02_2019_singleHiggs_lumi_set"$YEAR2
