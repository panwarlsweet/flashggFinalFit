...
parser = OptionParser(option_list=[
   ...
   # make_option("--target-names",type='string',dest='target_names',default='ttHToGG_M125_13TeV_powheg_pythia8_v2,GluGluHToGG_M-125_13TeV_powheg_pythia8,VBFHToGG_M-125_13TeV_powheg_pythia8'),
    make_option("--inp-files",type='string',dest='inp_files',default='ttHToGG_M125_13TeV_powheg_pythia8,GluGluHToGG_M-125_13TeV_powheg_pythia8,VBFHToGG_M-125_13TeV_powheg_pythia8,VHToGG_M125_13TeV_amcatnloFXFX_madspin_pythia8'),
  #  make_option("--inp-files",type='string',dest='inp_files',default='GluGluToHHTo2B2G_node_SM_13TeV-madgraph'),
   ...
   # make_option("--inp-names",type='string',dest='inp_names',default='GluGluToHHTo2B2G_node_SM_13TeV_madgraph'),
    make_option("--inp-dir",type='string',dest="inp_dir",default='/work/nchernya/DiHiggs/inputs/24_04_2019/2017/'),
  #  make_option("--out-dir",type='string',dest="out_dir",default='/work/nchernya/DiHiggs/inputs/05_04_2019/2017/'),
    make_option("--year",type='string',dest="year",default='2017'),
    make_option("--out-dir",type='string',dest="out_dir",default='/work/nchernya/DiHiggs/inputs/25_04_2019/2017/'),
