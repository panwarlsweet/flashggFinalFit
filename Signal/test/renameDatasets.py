...
parser = OptionParser(option_list=[
  ...
  #  make_option("--inp-files",type='string',dest='inp_files',default='ttHToGG_M125_13TeV_powheg_pythia8,GluGluHToGG_M-125_13TeV_powheg_pythia8,VBFHToGG_M-125_13TeV_powheg_pythia8,VHToGG_M125_13TeV_amcatnloFXFX_madspin_pythia8,GluGluToHHTo2B2G_node_SM_13TeV-madgraph_generated'),
   ...
   # make_option("--inp-names",type='string',dest='inp_names',default='GluGluToHHTo2B2G_node_SM_13TeV_madgraph'),
    make_option("--inp-dir",type='string',dest="inp_dir",default='/work/nchernya/DiHiggs/inputs/01_04_2019/2017/'),
    make_option("--out-dir",type='string',dest="out_dir",default='/work/nchernya/DiHiggs/inputs/01_04_2019/renamed2017/'),
...
#	input_files[num] = 'output_' + f  
	input_files[num] = 'output_' + f  +'_generated'
