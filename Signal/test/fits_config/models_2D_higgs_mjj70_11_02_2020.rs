...
Mjj_sig_sigma_cat2[25.0, 1.0, 60.0];
...
Mjj_sig_sigma_cat3[25.0, 1.0, 60.0];
Mjj_sig_alpha1_cat3[2.0, 1., 4.0];
Mjj_sig_n1_cat3[4.0, 3, 5.0];
Mjj_sig_alpha2_cat3[1.0, 0.05, 10.0];
Mjj_sig_n2_cat3[3.8, 3., 10.0];
...
Mjj_sig_sigma_cat4[25.0, 1.0, 60.0];
Mjj_sig_alpha1_cat4[2.0, .5, 4.0];
Mjj_sig_n1_cat4[4.0, 3, 5.0];
...
Mjj_sig_sigma_cat5[25.0, 1.0, 60.0];
Mjj_sig_alpha1_cat5[2.0, .5, 4.0];
Mjj_sig_n1_cat5[4.0, 2.5, 5.0];
...
Mjj_sig_sigma_cat6[25.0, 1.0, 60.0];
Mjj_sig_alpha1_cat6[2.0, .8, 4.0];
Mjj_sig_n1_cat6[3.0, 2, 5.0];
Mjj_sig_alpha2_cat6[1.0, 0.05, 4.0];
...
Mjj_sig_sigma_cat7[25.0, 1.0, 60.0];
Mjj_sig_alpha1_cat7[2.0, .8, 4.0];
Mjj_sig_n1_cat7[3.0, 2.0, 5.0];
Mjj_sig_alpha2_cat7[1.0, 0.05, 10.0];
Mjj_sig_n2_cat7[2.5, 1., 10.0];
...
Mjj_sig_sigma_cat8[25.0, 1.0, 60.0];
Mjj_sig_alpha1_cat8[1.0, .5, 4.0];
Mjj_sig_n1_cat8[4.0, 1.5, 5.0];
...
Mjj_sig_sigma_cat9[18.0, 1.0, 60.0];
Mjj_sig_alpha1_cat9[2.0, .7, 4.0];
Mjj_sig_n1_cat9[4.0, 3, 5.0];
Mjj_sig_alpha2_cat9[1.1, 0.05, 10.0];
...
Mjj_sig_sigma_cat10[25.0, 1.0, 60.0];
Mjj_sig_alpha1_cat10[2.0, .7, 4.0];
Mjj_sig_n1_cat10[4.0, 3, 5.0];
...
Mjj_sig_alpha1_cat11[2.0, 0.6, 4.0];
Mjj_sig_n1_cat11[4.0, 3.5, 5.0];
...
Mjj_hig_m0_vh_cat3[91, 88, 94];
Mjj_hig_sigma_vh_cat3[7, 5, 10];
Mjj_hig_alpha_vh_cat3[-0.5, -1., .0];
Mjj_hig_n_vh_cat3[2.0, 0.5, 10.0];
MjjHig_vh_cat3 = RooCBShape(Mjj, Mjj_hig_m0_vh_cat3, Mjj_hig_sigma_vh_cat3,Mjj_hig_alpha_vh_cat3,Mjj_hig_n_vh_cat3);

Mjj_hig_m0_vh_cat4[90, 87, 93];
Mjj_hig_sigma_vh_cat4[10, 5, 15];
Mjj_hig_alpha_vh_cat4[-0.5, -1., .0];
Mjj_hig_n_vh_cat4[2.0, 2, 10.0];
MjjHig_vh_cat4 = RooCBShape(Mjj, Mjj_hig_m0_vh_cat4, Mjj_hig_sigma_vh_cat4,Mjj_hig_alpha_vh_cat4,Mjj_hig_n_vh_cat4);

Mjj_hig_m0_vh_cat5[90, 87, 93];
Mjj_hig_sigma_vh_cat5[10, 5, 15];
Mjj_hig_alpha_vh_cat5[-0.5, -1., .0];
Mjj_hig_n_vh_cat5[2.0, 2, 10.0];
MjjHig_vh_cat5 = RooCBShape(Mjj, Mjj_hig_m0_vh_cat5, Mjj_hig_sigma_vh_cat5,Mjj_hig_alpha_vh_cat5,Mjj_hig_n_vh_cat5);

Mjj_hig_m0_vh_cat6[90, 87, 93];
Mjj_hig_sigma_vh_cat6[10, 5, 15];
Mjj_hig_alpha_vh_cat6[-0.5, -1., .0];
Mjj_hig_n_vh_cat6[2.0, 2, 10.0];
MjjHig_vh_cat6 = RooCBShape(Mjj, Mjj_hig_m0_vh_cat6, Mjj_hig_sigma_vh_cat6,Mjj_hig_alpha_vh_cat6,Mjj_hig_n_vh_cat6);

Mjj_hig_m0_vh_cat7[90, 87, 93];
Mjj_hig_sigma_vh_cat7[10, 5, 15];
Mjj_hig_alpha_vh_cat7[-0.5, -1., .0];
Mjj_hig_n_vh_cat7[2.0, 2, 10.0];
MjjHig_vh_cat7 = RooCBShape(Mjj, Mjj_hig_m0_vh_cat7, Mjj_hig_sigma_vh_cat7,Mjj_hig_alpha_vh_cat7,Mjj_hig_n_vh_cat7);

Mjj_hig_m0_vh_cat8[88, 85, 92];
Mjj_hig_sigma_vh_cat8[10, 5, 15];
Mjj_hig_alpha_vh_cat8[-0.5, -1., .0];
Mjj_hig_n_vh_cat8[4.0, 1, 10.0];
MjjHig_vh_cat8 = RooCBShape(Mjj, Mjj_hig_m0_vh_cat8, Mjj_hig_sigma_vh_cat8,Mjj_hig_alpha_vh_cat8,Mjj_hig_n_vh_cat8);

Mjj_hig_m0_vh_cat9[88, 85, 92];
Mjj_hig_sigma_vh_cat9[10, 5, 15];
Mjj_hig_alpha_vh_cat9[-0.5, -1., .0];
Mjj_hig_n_vh_cat9[4.0, 1, 10.0];
MjjHig_vh_cat9 = RooCBShape(Mjj, Mjj_hig_m0_vh_cat9, Mjj_hig_sigma_vh_cat9,Mjj_hig_alpha_vh_cat9,Mjj_hig_n_vh_cat9);

Mjj_hig_m0_vh_cat10[88, 85, 92];
Mjj_hig_sigma_vh_cat10[10, 5, 15];
Mjj_hig_alpha_vh_cat10[-0.5, -1., .0];
Mjj_hig_n_vh_cat10[4.0, 1, 10.0];
MjjHig_vh_cat10 = RooCBShape(Mjj, Mjj_hig_m0_vh_cat10, Mjj_hig_sigma_vh_cat10,Mjj_hig_alpha_vh_cat10,Mjj_hig_n_vh_cat10);

Mjj_hig_m0_vh_cat11[88, 85, 92];
Mjj_hig_sigma_vh_cat11[10, 5, 15];
Mjj_hig_alpha_vh_cat11[-0.5, -1., .0];
Mjj_hig_n_vh_cat11[4.0, 1,10.0];
MjjHig_vh_cat11 = RooCBShape(Mjj, Mjj_hig_m0_vh_cat11, Mjj_hig_sigma_vh_cat11,Mjj_hig_alpha_vh_cat11,Mjj_hig_n_vh_cat11);
...
Mjj_hig_m0_tth_cat3[130, 110, 150];
Mjj_hig_sigma_tth_cat3[30, 20, 70];
MjjHig_tth_cat3 = RooGaussian(Mjj, Mjj_hig_m0_tth_cat3, Mjj_hig_sigma_tth_cat3);

Mjj_hig_m0_tth_cat4[130, 110, 150];
Mjj_hig_sigma_tth_cat4[30, 20, 70];
MjjHig_tth_cat4 = RooGaussian(Mjj, Mjj_hig_m0_tth_cat4, Mjj_hig_sigma_tth_cat4);

Mjj_hig_m0_tth_cat5[130, 110, 150];
Mjj_hig_sigma_tth_cat5[30, 20, 70];
MjjHig_tth_cat5 = RooGaussian(Mjj, Mjj_hig_m0_tth_cat5, Mjj_hig_sigma_tth_cat5);

Mjj_hig_m0_tth_cat6[130, 110, 150];
Mjj_hig_sigma_tth_cat6[30, 20, 70];
MjjHig_tth_cat6 = RooGaussian(Mjj, Mjj_hig_m0_tth_cat6, Mjj_hig_sigma_tth_cat6);

Mjj_hig_m0_tth_cat7[130, 110, 150];
Mjj_hig_sigma_tth_cat7[30, 20, 70];
MjjHig_tth_cat7 = RooGaussian(Mjj, Mjj_hig_m0_tth_cat7, Mjj_hig_sigma_tth_cat7);

Mjj_hig_m0_tth_cat8[130, 110, 150];
Mjj_hig_sigma_tth_cat8[30, 20, 70];
MjjHig_tth_cat8 = RooGaussian(Mjj, Mjj_hig_m0_tth_cat8, Mjj_hig_sigma_tth_cat8);

Mjj_hig_m0_tth_cat9[130, 110, 150];
Mjj_hig_sigma_tth_cat9[30, 20, 70];
MjjHig_tth_cat9 = RooGaussian(Mjj, Mjj_hig_m0_tth_cat9, Mjj_hig_sigma_tth_cat9);

Mjj_hig_m0_tth_cat10[130, 110, 150];
Mjj_hig_sigma_tth_cat10[30, 20, 70];
MjjHig_tth_cat10 = RooGaussian(Mjj, Mjj_hig_m0_tth_cat10, Mjj_hig_sigma_tth_cat10);

Mjj_hig_m0_tth_cat11[130, 110, 150];
Mjj_hig_sigma_tth_cat11[30, 20, 70];
MjjHig_tth_cat11 = RooGaussian(Mjj, Mjj_hig_m0_tth_cat11, Mjj_hig_sigma_tth_cat11);
