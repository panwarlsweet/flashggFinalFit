...
def get_options():
    ...
    parser.add_option("--inp-files",type='string',dest='inp_files',default='hh_nlo_cHHH1,hh_nlo_cHHH5')  
    #parser.add_option("--inp-files",type='string',dest='inp_files',default='qqHH_CV_1_C2V_1_kl_1,qqHH_CV_1_C2V_2_kl_1,qqHH_CV_1_C2V_1_kl_2,qqHH_CV_1_C2V_1_kl_0,qqHH_CV_0p5_C2V_1_kl_1,qqHH_CV_1p5_C2V_1_kl_1,qqHH_CV_1_C2V_0_kl_1')  
    #parser.add_option("--inp-files",type='string',dest='inp_files',default='hh_nlo_cHHH0,hh_nlo_cHHH1,hh_nlo_cHHH2p45,hh_nlo_cHHH5,qqHH_CV_1_C2V_1_kl_1,qqHH_CV_1_C2V_2_kl_1,qqHH_CV_1_C2V_1_kl_2,qqHH_CV_1_C2V_1_kl_0,qqHH_CV_0p5_C2V_1_kl_1,qqHH_CV_1p5_C2V_1_kl_1,qqHH_CV_1_C2V_0_kl_1')  
    #parser.add_option("--inp-files",type='string',dest='inp_files',default='hh_nlo_cHHH1')
    #parser.add_option("--inp-files",type='string',dest='inp_files',default=qqHH_CV_1_C2V_1_kl_0,qqHH_CV_0p5_C2V_1_kl_1,qqHH_CV_1p5_C2V_1_kl_1,qqHH_CV_1_C2V_0_kl_1'hh_nlo_cHHH0,hh_nlo_cHHH1,hh_nlo_cHHH2p45,hh_nlo_cHHH5')  
    ...
    #parser.add_option("--inp-dir",type='string',dest="inp_dir",default='/eos/user/m/mukherje/HH_bbgg/Ntuples_RunII_VBF2Cat/Ntuple_run2/')
    #parser.add_option("--out-dir",type='string',dest="out_dir",default='/eos/user/m/mukherje/HH_bbgg/Ntuples_RunII_VBF2Cat/WSRoot/11_05_2020/')

    parser.add_option("--inp-dir",type='string',dest="inp_dir",default='/eos/user/m/mukherje/HH_bbgg/18_06_2020/from_Nadya/')
    parser.add_option("--out-dir",type='string',dest="out_dir",default='/eos/user/m/mukherje/HH_bbgg/18_06_2020/WS/')
   ...
   # parser.add_option("--MXcats",type='string',dest="MXcats",default='250,376,521,603,10000,250.,376,521,603,10000,250,376,521,603,10000')  #2d
    ...
    parser.add_option("--btag_config",type='string',dest="btag_config",default='../MetaData_HHbbgg/btagSF_22_04_2020.json')
