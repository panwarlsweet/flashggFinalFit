...
MX_sig_m0_cat0[980, 970, 1030];
MX_sig_sigma_cat0[15.0, 5.0, 60.0];
MX_sig_alpha1_cat0[1.2,1., 4.0];
MX_sig_n1_cat0[2.0, 2, 5.0];
...
MX_sig_m0_cat2[980, 970, 1030];
MX_sig_sigma_cat2[15.0, 5.0, 60.0];
MX_sig_alpha1_cat2[1.2,1., 4.0];
MX_sig_n1_cat2[2.0, 2, 5.0];
