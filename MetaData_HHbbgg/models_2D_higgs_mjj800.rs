...
Mjj_sig_m0_cat1[740, 700, 780];
Mjj_sig_sigma_cat1[10.0, 1.0, 60.0];
Mjj_sig_alpha1_cat1[1.0,0.05, 2.0];
Mjj_sig_n1_cat1[2.0, 0.1, 3.0];
Mjj_sig_alpha2_cat1[1.0, 0.05, 3.0];
Mjj_sig_n2_cat1[2.0, 0.1, 4.0];
...
Mjj_sig_m0_cat2[740, 700, 780];
Mjj_sig_sigma_cat2[10.0, 1.0, 60.0];
Mjj_sig_alpha1_cat2[1.0,0.05, 2.0];
Mjj_sig_n1_cat2[2.0, 0.1, 3.0];
Mjj_sig_alpha2_cat2[1.0, 0.05, 3.0];
Mjj_sig_n2_cat2[2.0, 0.1, 4.0];
